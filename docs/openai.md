...
> [!NOTE]
> OpenAI compatibility is experimental and is subject to major adjustments including breaking changes. For fully-featured access to the Ollama API, see the Ollama [Python library](https://github.com/YASSERRMD/Yolama-python), [JavaScript library](https://github.com/YASSERRMD/Yolama-js) and [REST API](https://github.com/YASSERRMD/Yolama/blob/main/docs/api.md).
